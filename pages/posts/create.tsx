...
export default function CreatePost() {
  ...
  const handleDelete = async () => {
    try {
      // Perform delete operation using Prisma or your preferred method
  ...
  const handleEdit = async () => {
    try {
      // Perform edit operation using Prisma or your preferred method
        ...
        <div className="p-4 bg-[#1f1b24b2] shadow-md text-white rounded-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 my-4 flex flex-col items-center justify-center">
            ...
            <div className="flex flex-row w-1/2 items-center justify-center">
              <Link href="/news" className="w-2/5 px-4 mx-4 py-2 bg-[#6da0f6] hover:bg-blue-500 text-[white] rounded-md2">
                wróć
              </Link>
              <button
                type="submit"
              ...
              <button
                type="button"
                className="w-2/5 px-4 mx-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md"
              ...
              <button
                type="button"
                className="w-2/5 px-4 py-2 bg-yellow-500 hover:bg-yellow-700 text-white rounded-md"
                onClick={handleEdit}
              >
                Edit Post
              </button>
